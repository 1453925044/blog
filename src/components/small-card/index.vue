<template>
<div class="card hideToShow">
    <!-- 登录框 -->
    <div class="login" v-if="prefix == 0">
        <p class="avatar">
            <img src="https://weichaooqx.com/figure/blog-images/my_avatar.jpg" alt="我的头像" />
        </p>
    ...
    <!-- 打赏小卡片、欢迎打赏 -->
    <div class="praise" v-if="prefix == 3">
        <p class="title">原创不易，感谢您对作者的支持!</p>
        <ul>
            <li>
                <img class="img" src="images/wx_ck.png" alt="微信收款码" />
                <span class="qrcode">微信收款码</span>
            </li>
            <li>
                <img class="img" src="images/zfb_ck.png" alt="支付宝收款码" />
